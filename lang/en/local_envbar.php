...
$string['pingprod_help'] = 'When this option is selected, the production server will be pinged to update the lastrefresh time for this environemnt.';
$string['pingprodverbose'] = 'Verbose mode';
$string['pingprodverbose_help'] = 'When this and the update production options are selected, a full debug of the curl reponse will be printed on the screen.';
