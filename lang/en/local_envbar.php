...
$string['highlightlinks_help'] = 'This setting controls if outgoing links to other environments, especially the production environment, are highlighted with a colored outline.';
$string['highlightlinksenvbar'] = 'Highlight links (Production)';
$string['highlightlinksenvbar_help'] = 'This setting controls if links within the envbar are also highlighted.';
...
$string['showconfiglink_help'] = 'This setting controls if the "Edit config" link is added to the envbar for users who are allowed to edit the envbar config.';
...
$string['stringseparator_help'] = 'This setting controls how the strings in the envbar will be separated. It defaults to a hyphen.';
