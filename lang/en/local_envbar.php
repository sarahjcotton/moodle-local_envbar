...
$string['dividerselector_desc'] = 'This is a css class that is used for the menu divider element. If you theme uses different html then you may need to adjust this selector.';
$string['extracss'] = 'Extra CSS';
$string['extracss_desc'] = 'This css is add only when the bar is visible and pinned to the top of the page. Your theme may also have fixed headers which may clash so this extra css should resolve the clash and move your main theme header down. If your header is fixed only at certain breakpoints then the media query in this extra css should be identical to the one in your theme.';
